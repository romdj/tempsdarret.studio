  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    it('should handle malformed data gracefully', async () => {
      ...
      const malformedInputs = [
        { title: '', clientEmail: 'client@example.com', photographerId: 'photographer_123' }, // Empty title
        { title: 'Test', clientEmail: 'invalid-email', photographerId: 'photographer_123' }, // Invalid email
        { title: 'A'.repeat(101), clientEmail: 'client@example.com', photographerId: 'photographer_123' }, // Title too long
      ];
