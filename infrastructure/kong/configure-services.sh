...
create_service "invitation-service" "http://invitation-service:3003"
...
create_route "invitation-service" "invitation-service-invitations" "/api/v1/invitations"
create_route "invitation-service" "invitation-service-magic-links" "/api/v1/magic-links"
